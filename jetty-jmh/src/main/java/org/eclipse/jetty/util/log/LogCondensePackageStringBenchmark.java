...
public class LogCondensePackageStringBenchmark
{
    ...
    @Benchmark
    public void testOldCondense(Blackhole blackhole)
    {
        blackhole.consume(AbstractLogger.condensePackageString(fqClassName));
    }

    @Benchmark
    public void testFastCondense(Blackhole blackhole)
    {
        blackhole.consume(AbstractLogger.condensePackageStringFast(fqClassName));
    }
